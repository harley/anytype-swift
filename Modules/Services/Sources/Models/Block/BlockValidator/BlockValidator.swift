...
public struct BlockValidator {
    ...
    public func validated(information info: BlockInformation) -> BlockInformation {
    ...
    public func validatedAlignment(alignment: LayoutAlignment, restrictions: BlockRestrictions) -> LayoutAlignment {
    ...
    public func validatedTextContent(content: BlockText, restrictions: BlockRestrictions) -> BlockText {
