...
public struct ClientCommands {
    ...
    public static func objectTypeRelationList(
        _ request: Anytype_Rpc.ObjectType.Relation.List.Request = .init()
    ) -> Invocation<Anytype_Rpc.ObjectType.Relation.List.Request, Anytype_Rpc.ObjectType.Relation.List.Response> {
        return Invocation(messageName: "ObjectTypeRelationList", request: request) { request in
            let requestData = try request.serializedData()
            let responseData = Lib.ServiceObjectTypeRelationList(requestData) ?? Data()
            return try Anytype_Rpc.ObjectType.Relation.List.Response(serializedData: responseData)
        }
    }
    ...
    public static func templateCreateFromObjectType(
        _ request: Anytype_Rpc.Template.CreateFromObjectType.Request = .init()
    ) -> Invocation<Anytype_Rpc.Template.CreateFromObjectType.Request, Anytype_Rpc.Template.CreateFromObjectType.Response> {
        return Invocation(messageName: "TemplateCreateFromObjectType", request: request) { request in
            let requestData = try request.serializedData()
            let responseData = Lib.ServiceTemplateCreateFromObjectType(requestData) ?? Data()
            return try Anytype_Rpc.Template.CreateFromObjectType.Response(serializedData: responseData)
        }
    }
